...
public abstract class TarUtils {
     ...
     * @throws Exception
     */
    public static Boolean archive(String srcPath, String destPath){
    ...
    public static void archive(File srcFile) throws Exception {
        ...
        String tarName = name + EXT;
        String destPath = Paths.get(basePath,tarName).toString();
        archive(srcFile, destPath);
    }
     ...
     * @throws Exception
     */
    public static Boolean dearchive(String srcPath){
    ...
    public static boolean delete(String tarFile) {
