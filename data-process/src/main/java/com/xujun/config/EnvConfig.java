...
public class EnvConfig {
    public final static String NOPROCESSNETSAVEFILE_DIR = "/net_save_file";
    public final static String HDFS_DIR = "/data";
    public final static Integer SEND_HDFS_RETRY_SUM = 3;
